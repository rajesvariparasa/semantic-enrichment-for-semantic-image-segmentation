...
def fit_fold(generator,model,batch_size, n_classes, optimizer, criterion, device):
    train_loss_history, val_loss_history, train_accuracy_history, val_accuracy_history = [], [],[],[]
   
    for train_data, val_data in generator:
    ...
    print("Fold Losses: ", train_loss_history, val_loss_history)
